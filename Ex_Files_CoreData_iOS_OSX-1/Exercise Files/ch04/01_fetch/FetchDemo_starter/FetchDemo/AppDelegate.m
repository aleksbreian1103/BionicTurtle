...
- (IBAction)createObjects:(id)sender {
    ...
    Course *second = (Course *) [NSEntityDescription
                                insertNewObjectForEntityForName:@"Course"
                                inManagedObjectContext:[self managedObjectContext]];
    second.title = @"TopTip 1.1";
    second.author = @"Aleksander Hansen";
    second.releaseDate = [dateFormatter dateFromString:@"17 Jan 2013"];
...
- (IBAction)fetchObjects:(id)sender {
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"releaseDate < %@", [NSDate date]];
